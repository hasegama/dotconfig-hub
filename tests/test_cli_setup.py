...
class TestSetupCommandWithOption:
    ...
    def test_setup_with_valid_templates_dir(
        self,
        runner: CliRunner,
        ...
        with patch("dotconfig_hub.cli.Path.cwd", return_value=temp_project_dir):
            with patch(
                "dotconfig_hub.cli.ProjectConfig", return_value=mock_project_config
            ):
    ...
    def test_setup_with_nonexistent_templates_dir(
    ...
    def test_setup_with_quoted_path(
        self, runner: CliRunner, temp_templates_dir: Path, temp_project_dir: Path
    ) -> None:
    ...
    def test_setup_with_tilde_path(
        self,
        runner: CliRunner,
        temp_project_dir: Path,
        mock_project_config: MagicMock,
        ...
        with tempfile.TemporaryDirectory() as home_dir:
            ...
            config_content = {
                "environment_sets": {
                    "test_env": {"description": "Test environment", "tools": {}}
                }
            }
            config_file = templates_dir / "config.yaml"
            with open(config_file, "w", encoding="utf-8") as f:
            ...
            with patch.dict(os.environ, {"HOME": home_dir}):
                with patch("dotconfig_hub.cli.Path.cwd", return_value=temp_project_dir):
                    with patch(
                        "dotconfig_hub.cli.ProjectConfig",
                        return_value=mock_project_config,
                    ):
                        result = runner.invoke(
                            setup, ["--templates-dir", "~/templates"]
                        )
...
class TestSetupCommandInteractive:
    ...
    def test_setup_interactive_valid_path(
        self,
    ...
    def test_setup_interactive_invalid_then_valid_path(
        self,
    ...
    @patch("dotconfig_hub.cli.Prompt.ask")
    @patch("dotconfig_hub.cli.Confirm.ask")
    def test_setup_interactive_cancel_after_invalid_path(
        self,
        mock_confirm: MagicMock,
        mock_prompt: MagicMock,
        runner: CliRunner,
    ...
    @patch("dotconfig_hub.cli.Prompt.ask")
    def test_setup_interactive_quoted_path(
        self,
        mock_prompt: MagicMock,
        runner: CliRunner,
        temp_templates_dir: Path,
    ...
    @patch("dotconfig_hub.cli.Prompt.ask")
    def test_setup_interactive_empty_input(
        self, mock_prompt: MagicMock, runner: CliRunner, temp_project_dir: Path
    ) -> None:
...
class TestSetupCommandValidation:
    ...
    def test_setup_missing_config_yaml(
        self, runner: CliRunner, temp_project_dir: Path
    ) -> None:
    ...
    def test_setup_invalid_config_yaml(
        self, runner: CliRunner, temp_project_dir: Path
    ) -> None:
    ...
    def test_setup_malformed_config_yaml(
        self, runner: CliRunner, temp_project_dir: Path
    ) -> None:
...
class TestSetupCommandOverride:
    ...
    @patch("dotconfig_hub.cli.Confirm.ask")
    def test_setup_override_existing_config(
        self,
        mock_confirm: MagicMock,
        runner: CliRunner,
        temp_templates_dir: Path,
        ...
        mock_project_config.get_templates_source.return_value = Path(
            "/other/templates/dir"
        )
    ...
    @patch("dotconfig_hub.cli.Confirm.ask")
    def test_setup_cancel_override(
        self,
        mock_confirm: MagicMock,
        runner: CliRunner,
        temp_templates_dir: Path,
